...
<head>
    ...
    <style>
        ...
        .form_wrapper input[type="password"]:focus {
            -webkit-box-shadow: 0 0 2px 1px rgba(21, 27, 78, 0.5);
            -moz-box-shadow: 0 0 2px 1px rgba(37, 28, 90, 0.5);
            box-shadow: 0 0 2px 1px rgba(33, 24, 78, 0.5);
            ...
            <div class="row clearfix">
                <div class="">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        @error('name')
                            <div style="color:#b52828; margin-bottom:25px">{{ $message }}</div>
                        @enderror
